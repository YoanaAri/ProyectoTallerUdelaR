 ...
 *                             <element name="value" type="{http://Service/}salidaTuristica" minOccurs="0"/>
 *                           </sequence>
 *                         </restriction>
 *                       </complexContent>
 *                     </complexType>
 ...
 *                           <sequence>
 *                             <element name="key" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *                             <element name="value" type="{http://Service/}categoria" minOccurs="0"/>
 *                           </sequence>
 *                         </restriction>
 *                       </complexContent>
 *                     </complexType>
...
public class Actividad {
    ...
    protected Actividad.Salidas salidas;
    @XmlElement(required = true)
    protected Actividad.Categorias categorias;
     ...
     * @return
     *     possible object is
     *     {@link Actividad.Salidas }
     *     
     */
    public Actividad.Salidas getSalidas() {
        return salidas;
    }
     ...
     *     
     */
    public void setSalidas(Actividad.Salidas value) {
        this.salidas = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Actividad.Categorias }
     *     
     */
    public Actividad.Categorias getCategorias() {
        return categorias;
    }
     ...
     *     
     */
    public void setCategorias(Actividad.Categorias value) {
    ...
    public static class Categorias {
        ...
        protected List<Actividad.Categorias.Entry> entry;
         ...
         * {@link Actividad.Categorias.Entry }
         * 
         * 
         * @return
         *     The value of the entry property.
         */
        public List<Actividad.Categorias.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<>();
            }
            return this.entry;
    ...
    public static class Salidas {
        ...
        protected List<Actividad.Salidas.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Actividad.Salidas.Entry }
         * 
         * 
         * @return
         *     The value of the entry property.
         */
        public List<Actividad.Salidas.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<>();
            }
            return this.entry;
        ...
        public static class Entry {
            ...
            protected String key;
            protected SalidaTuristica value;
             ...
             *     
             */
            public SalidaTuristica getValue() {
                return value;
            }
             ...
             *     
             */
            public void setValue(SalidaTuristica value) {
                this.value = value;
            }
