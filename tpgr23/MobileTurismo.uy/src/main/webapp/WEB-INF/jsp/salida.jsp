...
<html>
    ...
    <body class="bg-gray-200">
    	...
    	%>
			...
			<div style="width: 90%;" class="d-flex flex-column mt-5 p-4 align-content-center justify-self-center align-self-center shadow2 ">
            	
            	<h3 class="align-items-center titulos"> <%=salida.getNombre() %></h3>
            	...
            	<div class="d-flex flex-column align-items-end">
            		...
            		<a href="/MobileTurismo.uy/ConsultaActividad?name=<%=request.getAttribute("nombreAct")%>&dep=<%=request.getAttribute("nombreDep")%>">Consultar actividad turística.</a>
