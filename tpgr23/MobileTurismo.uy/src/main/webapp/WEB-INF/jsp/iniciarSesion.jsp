...
<html>
    ...
    <body class="bg-gray-200">
	    <jsp:include page="/WEB-INF/jsp/navPrincipal.jsp"/>
        <div class="d-flex mt-5 flex-row">
            <%-- <jsp:include page="/WEB-INF/jsp/menu.jsp"/> --%>
            
            <div class="w-full d-flex flex-row align-items-center justify-content-center">
                <form class="d-flex flex-column shadow2 py-5 px-4 align-self-center align-items-center" method="POST">
                    <h1 class="titulos mb-8">Turismo.uy</h1>
                    ...
                    <button  class="botones mt-4" type="submit"> Iniciar Sesion</button>
