...
<div class="d-flex mt-5 flex-row menu">
				...
				if (usr != null) { 
					 boolean esTurista = (boolean) session.getAttribute("es_turista");
				%>
	            	...
	            	%>
	            	<li ><a href="/DynamicTurismo.uy/AltaActividad"><h4 class="titulos">Alta Actividad</h4></a></li>
	            	<li ><a href="/DynamicTurismo.uy/AltaSalida"><h4 class="titulos">Alta Salida</h4></a></li>
	                <%
	            	}
	                else{ 
