            ...
            <div class="w-full d-flex flex-column align-items-center ">
            	...
            	<div class="d-flex flex-row justify-content-around w-full">   
	            	<div class="d-flex flex-column p-4 mr-5">
                    	...
                    	<div>
                    		<h4 class="subtitulos">Degusta</h4>
                	...
                	<div>
                		...
                		<div class="d-flex flex-row">
	                		 <img alt="degusta agosto" src="./img/comida2.jpg" class="secundarias mr-3 mb-3">
	                		 <a href="./Tsalida.html" class="align-self-center"><h4 class="subtitulos ">Degusta Agosto</h4></a>
                		</div>
                		<div class="d-flex flex-row">
	                		 <img alt="degusta" src="./img/comida1.jpeg" class="secundarias mr-3 mb-3">
	                		 <a href="./Tsalida.html" class="align-self-center"><h4 class="subtitulos">Degusta Setiembre</h4></a>
                		</div>                		
                    </div>           	
                </div>       
            </div>
