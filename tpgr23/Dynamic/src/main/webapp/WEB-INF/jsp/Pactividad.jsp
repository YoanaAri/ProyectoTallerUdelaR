            	...
            	<div class="d-flex flex-row justify-content-around w-full">   
                	...
                	<div>
                		...
                		<div class="d-flex flex-row">
	                		 ...
	                		 <a href="./Psalida.html" class="align-self-center"><h4 class="subtitulos ">Degusta Agosto</h4></a>
                		</div>
                		<div class="d-flex flex-row">
	                		 <img alt="degusta" src="./img/comida1.jpeg" class="secundarias mr-3 mb-3">
	                		 <a href="./Psalida.html" class="align-self-center"><h4 class="subtitulos">Degusta Setiembre</h4></a>
                		</div>                		
                    </div>           	
                </div>       
            </div>
